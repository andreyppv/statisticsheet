...
<script>
    ...
    if( $preview == "" ){
      ...
      document.cookie = "lander-ab-tests-11768289=lander_control";
    } else{
      document.cookie = "lander-ab-tests-11768289=lander_" + $preview;
    }

  </script>
<link rel="stylesheet" media="screen" href="https://assets3.clickfunnels.com/assets/lander.css"/>
<script type="text/javascript" src="https://static.clickfunnels.com/clickfunnels/landers/tmp/d3k5v2v3sdiziv9z.js" charset="UTF-8"></script>
